...
<form action="./TestUser" method="POST" accept-charset="utf-8">
Enter your e-mail:<br>
<input type="email" name="email" required="" placeholder="E-Mail" style="font-size: large; width: 300px; height: 30px"><br>
Enter your password:<br>
<input type="password" name="password" required="" placeholder="Password" style="font-size: large; width: 300px; height: 30px"><br>&nbsp;<br>
<input type="submit" value="Login" class="trd-btn trd-btn-alt">
<br>&nbsp;<br>
<h4>
