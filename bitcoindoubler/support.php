            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="trd-contact-form-wrapper col-md-6 col-sm-6 col-xs-12">
                        ...
                        <form action="javascript:alert('Message sent'); document.location = './support'">
                            ...
                            <button type="submit" class="btn btn-info" style="color: #ffffff;">Submit <span class="glyphicon glyphicon-envelope" style="color: #ffffff;"></span></button>
                        </form>
                    </div>
                    <!-- END -->
                    ...
                    <div class="trd-office-addresses-wrapper col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="trd-column col-md-12 col-sm-12 col-xs-12">
                            <!-- ADDRESSES -->
                            <div class="trd-office-address">
                                <h3 class="trd-office-title">UK Office</h3>
                                <ul>
                                    <li class="trd-office-location">78 Canterbury Rd, Sunderland, United Kingdom, SR5 3LD</li>
                                    <li class="trd-office-email">support@<?php echo $_SERVER['HTTP_HOST']; ?><br><br></li>
                                    <li><b>Company name:</b> BITCOIN FINANCE LTD</li>
                                    <li><b>Company number:</b> 10714202</li>
                                    <li><b>Check link:</b> <a href="https://beta.companieshouse.gov.uk/company/10714202" target="_blank">https://beta.companieshouse.gov.uk/company/10714202</a></li>
                                </ul>
                            </div>
                            <!-- END -->
                        </div>
